export const brandSettings = {
    logo: {
        src: "/assets/logo/cloaked_cyber_colored_logo.svg", // Add logo image URL here (e.g., "/assets/logo.png")
        alt: "CloakedCyber",
        variations: [ // you might have wordmarks / different color variants than what is listed here, that's fine just adjust it
            ...
            { 
                ...
                src: "/public/assets/logo/cloaked_cyber_black_logo.svg", // Add image path
                bg: "#ffffff", 
                darkText: true,
            ...
            { 
                ...
                src: "/public/assets/logo/cloaked_cyber_white_logo.svg", // Add image path
            ...
            // Wordmark variations
            {
                ...
                src: "/public/assets/logo/cloaked_cyber_colored_black_wordmark.svg", // Add image path
                bg: "#ffffff", 
                darkText: true,
                // description: "Use this version in thinner spaces with a white or light backgrounds.",
                size: "wordmark"
            ...
            { 
                ...
                src: "/public/assets/logo/cloaked_cyber_colored_white_wordmark.svg", // Add image path
                bg: "var(--color-rich-black)", 
                darkText: false,
                // description: "Use this version in thinner spaces with a dark or brand-colored backgrounds.",
                size: "wordmark"
            ...
            { 
                ...
                src: "/public/assets/logo/cloaked_cyber_black_wordmark.svg", // Add image path
                bg: "#ffffff", 
                darkText: true,
                // description: "For thinner spaces with a black and white print or single-color applications.",
                size: "wordmark"
            ...
            { 
                ...
                src: "/public/assets/logo/cloaked_cyber_white_wordmark.svg", // Add image path
                bg: "var(--color-deep-black)", 
                darkText: false,
                // description: "For thinner spaces with a dark backgrounds where color is not permitted.",
                size: "wordmark"
    ...
    favicon: "/public/assets/logo/cloakedcyber_profile_pic.png", // Add favicon URL here
    typography: {
