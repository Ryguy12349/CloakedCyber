export const brandSettings = {
    logo: {
        src: "src/assets/Cloaked Cyber Colored Logo.svg", // Add logo image URL here (e.g., "/assets/logo.png")
        alt: "CloakedCyber",
        variations: [ // you might have wordmarks / different color variants than what is listed here, that's fine just adjust it
            { 
                ...
                src: "src/assets/Cloaked Cyber Colored Black WordMark.svg", // Add image path
                bg: "#ffffff", 
                darkText: true,
            ...
            { 
                ...
                src: "src/assets/Cloaked Cyber Colored White WordMark.svg", // Add image path
                bg: "#333333", 
                darkText: false,
            ...
            { 
                ...
                src: "src/assets/Cloaked Cyber Black WordMark.svg", // Add image path
                bg: "#ffffff", 
                darkText: true,
            ...
            { 
                ...
                src: "src/assets/Cloaked Cyber White WordMark.svg", // Add image path
                bg: "#000000", 
                darkText: false,
